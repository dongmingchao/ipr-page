import { OnInit, EventEmitter, NgZone, AfterViewInit, AfterViewChecked } from '@angular/core';
...
export declare class CosmeticsDetailComponent implements OnInit, AfterViewInit, AfterViewChecked {
